...
<main>
	<!-- php
	    ...
	    // }
	?> -->
	<form action="{{ url('studentprofile',['student'=>Auth::user()->id, 'address'=>$address->id]) }}" method="post">
        @method('PUT')
         @csrf
				...
				<div class="col-md-5 border-right">
						...
						<div class="row mt-2">
							<div class="col-md-12" style="font-size: 18px;">
								...
								<input style="font-size: 16px;" type="text" class="form-control @error('first_name') is-invalid @enderror" onkeydown="return alphaOnly(event);" name="first_name" placeholder="{{Auth::user()->first_name}}"  required maxlength="255" value={{Auth::user()->first_name}}>
							...
							<div class="col-md-12" style="font-size: 18px;">
								...
								<input style="font-size: 16px;" type="text" class="form-control @error('middle_name') is-invalid @enderror" onkeydown="return alphaOnly(event);" name="middle_name" placeholder="{{Auth::user()->middle_name}}" maxlength="255" value={{Auth::user()->middle_name}}>
								<div class="invalid-feedback">
							...
							<div class="col-md-12" style="font-size: 18px;">
								...
								<input style="font-size: 16px;" type="text" class="form-control @error('last_name') is-invalid @enderror" onkeydown="return alphaOnly(event);" name="last_name" placeholder="{{Auth::user()->last_name}}"  required maxlength="255" value={{Auth::user()->last_name}}>
								<div class="invalid-feedback">
							...
							<div class="col-md-12" style="font-size: 18px;">
								<label>Suffix</label>
								<input style="font-size: 16px;" type="text" class="form-control @error('suffix') is-invalid @enderror" onkeydown="return alphaOnly(event);" name="suffix" maxlength="255" placeholder="{{Auth::user()->suffix}}" value={{Auth::user()->suffix}}>
								<div class="invalid-feedback">
