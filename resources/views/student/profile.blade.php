	    ...
	    <div class="container rounded bg-white mt-5 mb-5 top-to-bottom">
			...
			<div class="row">
				...
				<div class="col-md-5 border-right">
						...
						<div class="row mt-2">
							<div class="col-md-4" style="font-size: 18px;"><label>First Name</label><input style="font-size: 16px;" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" placeholder="{{Auth::user()->first_name}}" value={{Auth::user()->first_name}}></div>
							<div class="col-md-4" style="font-size: 18px;"><label>Middle Name</label><input style="font-size: 16px;" type="text" class="form-control @error('middle_name') is-invalid @enderror" name="middle_name" placeholder="{{Auth::user()->middle_name}}" value={{Auth::user()->middle_name}}></div>
							<div class="col-md-4" style="font-size: 18px;"><label>Last Name</label><input style="font-size: 16px;" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" placeholder="{{Auth::user()->last_name}}" value={{Auth::user()->last_name}}></div>
						</div><br/>
						<div class="row mt-3">
