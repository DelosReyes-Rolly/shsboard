        ...
        <div>
            ...
            <div class="card mb-4">
                <div class="card border-start-lg border-start-yellow">
                    <div class="card-header"><i class="fas fa-trash-alt fa-3x"></i><font face = "Bedrock" size = "7"><b>  Delete Record</b></font></div>
                        ...
                        <div class="row gx-3 mb-3" style="color: black">
                            ...
                            <form method="post" action="{{ url('deletegraderequest',['id'=>$request->id]) }}">
                                ...
                                <div class="alert alert-danger">
                                    ...
                                    <p style="color: red; font-size:20px;">Are you sure you want to delete request ?</p>
