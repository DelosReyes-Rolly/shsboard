		...
		<div class="container">
			...
			<center>
				@if($course->image == NULL)
					<img src="{{ URL::asset('img/shs.png')}}" style="width: 600px; height: 600px;" class="left-to-right">
				@else
					<img src="{{ asset('img/'.$course->image) }}" style="width: 600px; height: 600px;" class="left-to-right"/>
				@endif<br><br>
