                                                ...
                                                <div class="body">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                                            <div class="img-post">
                                                                @if($announcements->image != NULL)
                                                                    <center><img class="d-block img-fluid announcement-image" src="{{ asset('uploads/announcement/'.$announcements->image) }}"/></center>
                                                                @else
                                                        ...
                                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                                            ...
                                                            <a class="btn btn-md btn-success" href="{{ url('seePublicAnnouncement',['id'=>$announcements->id]) }}"><em>read more...</em></a>
                                                        </div>
                                                    </div>
                                                    <div class="footer">
                                                        <ul class="stats">
