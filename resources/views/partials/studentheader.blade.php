...
<body>
    ...
    <div class="wrapper">
        <!-- Sidebar  -->
        <nav id="sidebar" class="sticky-top h-100 vh-100" style="padding-bottom: 800px; box-shadow: 0 4px 16px rgba(0,0,0,1);">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item" title="Profile">
                                <a class="nav-link header-letter"  href="{{ url('/studentprofile') }}" style="color:#fff; border-top: none;">Profile</a>
                            </li>
                            <li class="nav-item" title="Change Password">
                                <a class="nav-link header-letter" href="/password-student/{{Auth::user()->id}}" style="color:#fff; border-top: none;">Change Password</a>
                            </li>
