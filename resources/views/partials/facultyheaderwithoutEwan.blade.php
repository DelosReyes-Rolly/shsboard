        ...
        <div id="content" style="padding: 0px;">
            ...
            <nav class="navbar navbar-expand-lg navbar-light sticky-top">
                <div class="container-fluid">
                    ...
                    <div class="greetingstop" style="padding-left:10px; color: #fff; font-weight:bold; font-style: Verdana;">Welcome Teacher {{Auth::user()->first_name}}!</div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item" title="Profile">
                                <a class="header-letter navbar-a"  href="{{ url('/facultyprofile') }}" style="color:#fff; border-top: none;">Profile</a>&emsp;
                            </li>
                            <li class="nav-item" title="Change Password">
                                <a class="header-letter navbar-a" href="{{ url('password-faculty',['id'=>Auth::user()->id]) }}" style="color:#fff; border-top: none;">Change Password</a>&emsp;
                            </li>
                            <li class="nav-item" title="Logout  ">
                                <a class="header-letter navbar-a" href="{{ route('logout') }}"onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color:#fff; border-top: none;">{{ __('Logout') }}</a>&emsp;
