...
<section>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row requestdocument">
                                                ...
                                                <div class="col-lg-6 col-md-12 form-group">
                                                    ...
                                                    <select id="subject_id" name="subject_id" value="{{ old('subject_id') }}" class="form-control" required>
                                            ...
                                            <div class="row gx-3 mb-3 requestdocument">
                                                ...
                                                <div class="col-lg-4 col-md-12 form-group">
                                                    ...
                                                    <select id="section_id" name="section_id" value="{{ old('section_id') }}" class="form-control" required>
                                                ...
                                                <div class="col-lg-4 col-md-12 form-group">
                                                    ...
                                                    <select id="gradelevel_id" name="gradelevel_id" value="{{ old('gradelevel_id') }}" class="form-control" required>
                            ...
                            <div class="modal fade" id="Activity-modal-update" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content border-start-lg border-start-yellow">
                                        ...
                                        <form action="javascript:void(0)" id="ActivityFormUpdate" name="ActivityFormUpdate" class="form-horizontal" method="POST">
                                            <div class="modal-body">
    ...
    $(document).ready( function () {
        ...
        $('#example').DataTable({
            ...
            { data: 'created_atAct', name: 'created_atAct',
                "render": function (data) {
                    var date = new Date(data);
                    return month[date.getMonth()] + " " + date.getDate() + ", " + date.getFullYear();
                }
            },
            { data: 'expired_atAct', name: 'expired_atAct',
                "render": function (data) {
                    var date = new Date(data);
                    return month[date.getMonth()] + " " + date.getDate() + ", " + date.getFullYear();
                }
