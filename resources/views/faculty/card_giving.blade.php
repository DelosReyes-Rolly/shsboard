                        ...
                        <div class="row gx-3 mb-3" style="color: black">
                            ...
                            <form method="post" action="/cards/{{$card->id}}}">
                                ...
                                <div class="alert alert-primary">
                                    <input type="hidden" name="cardgiving" value="1">
                                    <p style="color: black; font-size:20px;"><b>Are you sure you want to release the card of {{$card->course->courseName}} - {{$card->section->section}}?</b></p>
