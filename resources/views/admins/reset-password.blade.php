            ...
            <div class="right">
                ...
                <form action="{{ url('/reset-password-admin') }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password"  name="new_password" class="form-control" required minlength="6" required/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password"  name="confirm_password" class="form-control" required minlength="6" required/>
                        <div class="invalid-feedback">
                            Please input valid password.
                        </div>
                    </div>
