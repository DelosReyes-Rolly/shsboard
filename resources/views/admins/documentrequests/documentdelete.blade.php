<div class="modal-header">
    <h1 class="modal-title" id="staticBackdropLabel" style="font-size: 20px;">Delete Document </h1>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<form method="POST" id="deletedDocument{{$document->id}}">   
...
<script>
        $("#deletedDocument"+id).submit(function(e) {
            e.preventDefault();
