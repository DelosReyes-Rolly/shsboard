    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <textarea class="form-control @error('content') is-invalid @enderror" id="editor2" type="text" placeholder="Enter the information" name="content" rows="10" cols="80">{{$landing->content}}</textarea>
            </div><br/>
        </div>
    </div>
