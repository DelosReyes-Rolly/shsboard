...
<form method="POST" action="/updateannouncement/{{$announcement->id}}" class="needs-validation" novalidate>
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-12"><br/>
                ...
                <input type="time" id="time" class="form-control" name="whn_time" value="{{$announcement->whn_time}}" required>
                <div class="invalid-feedback">
                    Please input time.
                </div>
            </div>
