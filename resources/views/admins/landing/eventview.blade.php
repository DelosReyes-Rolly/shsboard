...
<main>
        <div>
            <div class="container-xl px-4 mt-4 left-to-right">
                <!-- page navigation-->
                <h3 style="font-size: 20px;">View Event </h3>
                <hr class="mt-0 mb-4">
                <div class="row">
                            ...
                            <div class="card border-start-lg border-start-yellow">
                                ...
                                <div class="card-body" style="padding: 10px 40px 10px 40px">
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <!-- Form Group date-->
                                        <div class="col-md-6">
                                            <label class="large mb-1" for="inputwho"><b>Who: </b></label>
                                            {{$event->who}}
                                        </div>
                                    </div><br/>
                                    <!-- Form Row -->
                                    <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                {{$requested_at  =   date('F d, Y', strtotime($event->whn))}}
                                            </div>
                                            <!-- Form Group (content)-->
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="appt"><b>Time: </b></label>
                                                    {{$time_start =  date('h:i A', strtotime($event->whn_time))}}
                                                </div>
                                            </div>
                                            <!-- Form Group whr-->
                                            <div class="col-md-3">
                                                <label class="slarge mb-1" for="inputexpired_at"><b>Expired at: </b></label>
                                                {{$requested_at  =   date('F d, Y', strtotime($event->expired_at))}}
                                            </div>
                                            <!-- Form Group (location)-->
                                            <div class="col-md-6">
                                                <label class="large mb-1" for="inputwhr"><b>Where: </b></label>
                                                {{$event->whr}}
                                            </div>
                                        </div><br/>
                                        @if($event->image != NULL)
