...
<main>
                            ...
                            <div class="border-start-lg border-start-yellow">
                                ...
                                <div class="card-body" style="padding: 10px 40px 10px 40px">
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-4"><br />
                                            <br><label class="slarge mb-1" for="inputpost_release" style="font-size: 20px;"><span style="color: red">*</span> Release Date</label>
                                            <input style="font-size:20px;" type="date" class="form-control @error('post_release') is-invalid @enderror" id="inputpost_release" placeholder="Enter the date" name="post_release" value="{{ old('post_release') }}" required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea style="font-size:20px;" class="form-control @error('contents') is-invalid @enderror" id="contents" type="text" placeholder="Enter the information" name="contents" rows="10" cols="80" required>{{ old('content') }}</textarea>
                                        <div class="invalid-feedback">
                ...
                <form action="javascript:void(0)" id="AnnouncementFormUpdate" name="AnnouncementFormUpdate" class="form-horizontal needs-validation" novalidate method="POST">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"><br />
                                <label class="slarge mb-1" for="release_at" style="font-size: 20px;"><span style="color: red">*</span> Release Date</label>
                                <input id="release_at-update" style="font-size: 18px;" type="date" class="form-control @error('post_release') is-invalid @enderror" placeholder="Enter the date" name="release_at" required>
                                <div class="invalid-feedback">
                                    Please input expiry date.
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('/countpublicannouncement') }}",
                dataType: 'json',
        ...
        $('#addAnnouncement').submit(function(e) {
            e.preventDefault();
            if ($('#addAnnouncement')[0].checkValidity() === false) {
                e.stopPropagation();
            } else {
                var formData = new FormData(this);
                $(":submit").attr("disabled", true);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response) {
                            ...
                            $(":submit").removeAttr("disabled");
                            $('#addAnnouncement').trigger("reset").removeClass('was-validated');
                        }
                    },
                    complete: function() {
                        $.ajax({
            ...
            $('#addAnnouncement').addClass('was-validated');
