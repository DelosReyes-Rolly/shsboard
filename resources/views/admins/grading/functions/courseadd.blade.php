    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="text" name="courseName"  class="form-control @error('courseName') is-invalid @enderror" value="{{ old('courseName') }}" onkeydown="return alphaOnly(event);" style="font-size: 14px;" required>
            ...
            <div class="col-md-12"><br/>
                ...
                <input type="text" name="abbreviation"  class="form-control @error('abbreviation') is-invalid @enderror" value="{{ old('abbreviation') }}" onkeydown="return alphaOnly(event);" style="font-size: 14px;" required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-12"><br/>
                ...
                <textarea name="description" id="editor2" type=text class="form-control @error('description') is-invalid @enderror">{{ old('description') }}</textarea style="font-size: 14px;" required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-12"><br/>
                ...
                <input type="text" name="code"  class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}"style="font-size: 14px;" required>
                <div class="invalid-feedback">
