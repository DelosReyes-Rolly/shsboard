<div class="modal-header">
    <h1 class="modal-title" id="staticBackdropLabel" style="font-size: 20px;">Delete Grade Level </h1>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<form method="POST" id="deletedGradelevel{{$gradelevel->id}}">   
...
<script>
        $("#deletedGradelevel"+id).submit(function(e) {
            e.preventDefault();
