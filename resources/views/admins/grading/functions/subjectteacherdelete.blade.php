...
@include('partials.adminSecondHeader')
        <div class="left-to-right">
            <h3 style="font-size: 28px; font-weight: 800;">Delete Teacher's Subject</h3>  
            <hr class="mt-0 mb-4">
            <div class="card mb-4">
                <div class="card border-start-lg border-start-yellow">
                    ...
                    <div class="card-body" style="padding: 10px 40px 10px 40px">
                        ...
                        <div class="row gx-3 mb-3" style="color: black">
                            ...
                            @endif
                            <form method="post" action="/deletesubjectteacher/{{$subjectteacher->id}}">
                                @method('PUT')
                                @csrf
                                <div class="alert alert-danger">
                                    <input type="hidden" name="deleted" value="1">
                                    <input type="hidden" name="deleted_at" value={{now();}}>
                                    <p style="color: red; font-size:20px;">Are you sure you want to delete teacher subject?</p>
