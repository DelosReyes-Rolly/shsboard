...
@include('partials.adminSecondHeader')
        <div class="left-to-right">
            <h3 style="font-size: 20px;">Delete Student</h3>  
            <hr class="mt-0 mb-4">
                        ...
                        <div class="row gx-3 mb-3" style="color: black">
                            ...
                            <form method="post" action="/deletestudent/{{$student->id}}">
                                ...
                                <div class="alert alert-danger">
                                    ...
                                    <p style="color: red">Are you sure you want to delete the records of <b>{{$student->last_name}}, {{$student->first_name}} {{$student->middle_name}}</b>?</p>
