...
<form method="POST" id="bulkStudent" action="" enctype="multipart/form-data"  class="needs-validation" novalidate>
    <div class="modal-body">
        ...
        <center><a href="/downloadStudentFileFormat" class="btn btn-primary"><i class="fas fa-download"></i> Download Required File Format</a></center>
        <br/>
        <div class="mb-3" style="color: red">
            * required field
        </div>
        <div style="font-size: 20px;"><span style="color: red">*</span> Upload Excel file with the required format only</div>
        <input type="file" name="select_file" id="select_field" class="form-control" style="font-size: 16px;" required>
