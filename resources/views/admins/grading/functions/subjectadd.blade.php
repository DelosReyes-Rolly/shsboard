...
<div class="left-to-right">
        ...
        <form method="POST" action="{{ route('subject.store') }}" enctype="multipart/form-data">
            ...
            <div class="container-xl px-4 mt-4">
                <!-- page navigation-->
                <h3 style="font-size: 20px;">Create Subject</h3>
                <hr class="mt-0 mb-4">
                <div class="row">
                        ...
                        <div class="card mb-4">
                            <div class="card border-start-lg border-start-yellow">
                                <div class="card-header"><font face = "Bedrock" size = "6"><b><i class="fas fa-pencil-alt"></i> Create Subject Information</b></font></div>
                                <div class="card-body" style="padding: 10px 40px 10px 40px">
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <textarea type="text" name="description" id="editor" class="form-control @error('description') is-invalid @enderror" style="font-size: 14px;">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                                    <hr>
                                    <a class="btn btn-info btn-md" href="/gradingsubjects"><i class="fas fa-arrow-left"></i> Back</a>
