    ...
    <div class="modal fade" id="Schoolyear-modal" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content border-start-lg border-start-yellow">
                ...
                <form action="javascript:void(0)" id="SchoolyearForm" name="SchoolyearForm" class="form-horizontal" method="POST">
    ...
    <div class="modal fade" id="Schoolyear-modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content border-start-lg border-start-yellow">
                ...
                <form action="javascript:void(0)" id="SchoolyearFormUpdate" name="SchoolyearFormUpdate" class="form-horizontal" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <input id="schoolyear-update" type="text" name="schoolyear" class="form-control @error('schoolyear') is-invalid @enderror" style="font-size: 20px;"  onkeypress="return onlyNumberKey(event)" maxlength="4" minlength="4" required>
                                <div class="invalid-feedback">
                                    Please input valid school year.
                                </div>
                            </div>
