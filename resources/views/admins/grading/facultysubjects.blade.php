...
<div class="left-to-right">
        ...
        @endif
        <h3 style="font-size: 20px;">Table of Teacher's Subjects </h3>
        <hr class="mt-0 mb-4">
                                ...
                                ?>
                                    @foreach ($subjectteachers as $subjectteacher)  
                                        <tr id="{{$subjectteacher -> id}}">
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-sm" href="/viewsubjectteacher/{{$subjectteacher->id}}"><i class="fas fa-eye"></i> View</a>
