    ...
    <div class="modal fade" id="Expertise-modal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content border-start-lg border-start-yellow">
                ...
                <form action="javascript:void(0)" id="ExpertiseForm" name="ExpertiseForm" class="form-horizontal" method="POST">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="Expertise-modal-update" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content border-start-lg border-start-yellow">
                ...
                <form action="javascript:void(0)" id="ExpertiseFormUpdate" name="ExpertiseFormUpdate" class="form-horizontal" method="POST">
                    <div class="modal-body">
