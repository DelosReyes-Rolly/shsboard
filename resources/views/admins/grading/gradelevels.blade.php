...
<main>
    ...
    <div class="modal fade" id="Gradelevel-modal" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content border-start-lg border-start-yellow">
                ...
                <form action="javascript:void(0)" id="GradelevelForm" name="GradelevelForm" class="form-horizontal needs-validation" novalidate method="POST">
    ...
    <div class="modal fade" id="Gradelevel-modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content border-start-lg border-start-yellow">
                ...
                <form action="javascript:void(0)" id="GradelevelFormUpdate" name="GradelevelFormUpdate" class="form-horizontal needs-validation" novalidate method="POST">
                    <div class="modal-body">
    ...
    <script type="text/javascript">
        ...
        function add() {
            $('#GradelevelForm').trigger("reset").removeClass('was-validated');
        ...
        function editFunc(id) {
            $('#GradelevelFormUpdate').trigger("reset").removeClass('was-validated');
        ...
        $('#GradelevelForm').submit(function(e) {
            e.preventDefault();
            if ($('#GradelevelForm')[0].checkValidity() === false) {
                e.stopPropagation();
            } else {
            ...
            $('#GradelevelForm').addClass('was-validated');
        });

        $('#GradelevelFormUpdate').submit(function(e) {
            e.preventDefault();
            if ($('#GradelevelFormUpdate')[0].checkValidity() === false) {
                e.stopPropagation();
            } else {
                var formData = new FormData(this);
                $(":submit").attr("disabled", true);
            ...
            $('#GradelevelFormUpdate').addClass('was-validated');
        });
