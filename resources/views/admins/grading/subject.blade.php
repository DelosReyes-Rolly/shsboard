...
<main>
    ...
    <div class="modal fade" id="Subject-modal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content border-start-lg border-start-yellow">
                ...
                <form action="javascript:void(0)" id="SubjectForm" name="SubjectForm" class="form-horizontal needs-validation" novalidate method="POST">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="Subject-modal-update" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content border-start-lg border-start-yellow">
                ...
                <form action="javascript:void(0)" id="SubjectFormUpdate" name="SubjectFormUpdate" class="form-horizontal needs-validation" novalidate method="POST">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="Subject-modal-delete" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content border-start-lg border-start-yellow">
                <div class="modal-header">
                    <h1 class="modal-title" id="SubjectModalDelete" style="font-size: 20px;">Delete Subject</h1>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script type="text/javascript">
        ...
        function add() {
            $('#SubjectForm').trigger("reset").removeClass('was-validated');
        ...
        function editFunc(id) {
            $('#SubjectFormUpdate').trigger("reset").removeClass('was-validated');
        ...
        $('#SubjectForm').submit(function(e) {
            e.preventDefault();
            if ($('#SubjectForm')[0].checkValidity() === false) {
                e.stopPropagation();
            } else {
            ...
            $('#SubjectForm').addClass('was-validated');

        });

        $('#SubjectFormUpdate').submit(function(e) {
            e.preventDefault();
            if ($('#SubjectFormUpdate')[0].checkValidity() === false) {
                e.stopPropagation();
            } else {
                var formData = new FormData(this);
                $(":submit").attr("disabled", true);
            ...
            $('#SubjectFormUpdate').addClass('was-validated');
