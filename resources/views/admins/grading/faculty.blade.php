...
<main>
    ...
    <div class="left-to-right">
        ...
        @endif
        <h3 style="font-size: 20px;">Table of Teachers </h3>
        <hr class="mt-0 mb-4">
                                ...
                                ?>
                                    @foreach ($faculties as $faculty)
                                        <tr>
                                            ...
                                            <td>{{$faculty -> email}}</td>
                                            <td>
                                                <a class="btn btn-success btn-sm" href="/viewfaculty/{{$faculty->id}}"><i class="fas fa-eye"></i> View</a>
                                                <a class="btn btn-warning btn-sm" href="/showfaculty/{{$faculty->id}}"><i class="fas fa-edit"></i> Update</a>
                                                <a class="btn btn-danger btn-sm" href="{{route('admin.deletefaculty', $faculty->id)}}"><i class="far fa-trash-alt"></i> Delete</a>
                                            </td> 
                                        </tr>
                                    @endforeach 
                            </tbody>
