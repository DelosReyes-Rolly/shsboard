                    ...
                    <div id="batchModal" class="modal fade" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content border-start-lg border-start-yellow">
                                ...
                                <form method="POST" id="bulkFaculty" action="" enctype="multipart/form-data">
                ...
                <div id="editmin" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content border-start-lg border-start-yellow">
                            ...
                            <form action="javascript:void(0)" method="POST" name="updateMinload" class="form-horizontal" id="updateMinload">
                                <div class="modal-body">
                                <div id="whoops" class="alert alert-danger" style="display: none;">
                                    <b>Whoops! There is a problem in your input</b> <br/>
                                    <div id="validation-errors"></div>
                ...
                <div id="editmax" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content border-start-lg border-start-yellow">
                            ...
                            <form action="javascript:void(0)" method="POST" name="updateMaxload" class="form-horizontal" id="updateMaxload">
                                <div class="modal-body">
                                <div id="whoops" class="alert alert-danger" style="display: none;">
                                    <b>Whoops! There is a problem in your input</b> <br/>
                                    <div id="validation-errors"></div>
                ...
                <div class="modal fade" id="Faculty-modal" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content border-start-lg border-start-yellow">
                            ...
                            <form action="javascript:void(0)" id="FacultyForm" name="FacultyForm" class="form-horizontal" method="POST">
                                <div class="modal-body">
                ...
                <div class="modal fade" id="Faculty-modal-update" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content border-start-lg border-start-yellow">
                            ...
                            <form action="javascript:void(0)" id="FacultyFormUpdate" name="FacultyFormUpdate" class="form-horizontal" method="POST">
                                <div class="modal-body">
