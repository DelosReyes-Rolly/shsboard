...
<main>
    ...
    <div class="modal fade" id="Section-modal" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content border-start-lg border-start-yellow">
                ...
                <form action="javascript:void(0)" id="SectionForm" name="SectionForm" class="form-horizontal needs-validation" novalidate method="POST">
    ...
    <div class="modal fade" id="Section-modal-update" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content border-start-lg border-start-yellow">
                ...
                <form action="javascript:void(0)" id="SectionFormUpdate" name="SectionFormUpdate" class="form-horizontal needs-validation" novalidate method="POST">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="Section-modal-delete" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content border-start-lg border-start-yellow">
                <div class="modal-header">
                    <h1 class="modal-title" id="SectionModalDelete" style="font-size: 20px;">Delete Section</h1>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script type="text/javascript">
        ...
        function add() {
            $('#SectionForm').trigger("reset").removeClass('was-validated');
        ...
        function editFunc(id) {
            $('#SectionFormUpdate').trigger("reset").removeClass('was-validated');
        ...
        $('#SectionForm').submit(function(e) {
            ...
            if ($('#SectionForm')[0].checkValidity() === false) {
                e.stopPropagation();
            } else {
        ...
        $('#SectionFormUpdate').submit(function(e) {
            ...
            if ($('#SectionFormUpdate')[0].checkValidity() === false) {
            ...
            $('#SectionFormUpdate').addClass('was-validated');
        });
